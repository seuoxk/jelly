...
export default function MainScreen({ navigation }) {
  ...
  return <SafeAreaView style={styles.safeArea}><ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
    <View style={styles.header}><View><Text style={styles.eyebrow}>BEACH SAFETY</Text><Text style={styles.title}>오늘 바다는 안전할까요?</Text></View><View style={styles.waveBadge}><Ionicons name="water" size={24} color="#0369A1" /></View></View>
